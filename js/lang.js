...
function setLang(lang) {
  ...
  /* ── Traducir los <optgroup label="..."> del formulario de prints ── */
  document.querySelectorAll('[data-es-label]').forEach(el => {
    const translation = el.getAttribute('data-' + lang + '-label');
    if (translation) el.label = translation;
  });

  /* ── Traducir los placeholder="..." de inputs/textarea ── */
